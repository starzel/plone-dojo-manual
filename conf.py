...
man_pages = [
    ('index', 'plone ', u'Mastering Plone Documentation',
     [u'Philip Bauer'], 1)
]
...
texinfo_documents = [
  ('index', 'Dojo', u'Plone Coding Dojo',
   u'Philip Bauer', 'Plone Coding Dojo', 'One line description of project.',
   'Miscellaneous'),
]
